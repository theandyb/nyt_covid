...
json_data <- fromJSON("https://services.arcgis.com/G4S1dGvn7PIgYd6Y/arcgis/rest/services/COVID19_Statistics_Chester_County__PA/FeatureServer/3/query?f=json&where=1%3D1&returnGeometry=false&spatialRel=esriSpatialRelIntersects&outFields=*&orderByFields=Date_of_Report%20asc&outSR=102100&resultOffset=0&resultRecordCount=32000&resultType=standard&cacheHint=true")
